...
int main(int argc, char *argv[])
{
    ...
    desc.add_options()
        ...
        ("graph,g", po::value<std::string>(&graph_file)->default_value("data/riskmaps/viking20_01_uniform_1.graphml"), "graph")
        ("map,m", po::value<std::string>(&map_file)->default_value("data/envs/vikings20.jpg"), "image")
        ("startx", po::value<double>(&startx)->default_value(0.95), "startx")
        ("starty", po::value<double>(&starty)->default_value(0.35), "starty")
        ("goalx",  po::value<double>(&goalx)->default_value(0.10),   "goalx")
        ("goaly",  po::value<double>(&goaly)->default_value(0.28),   "goaly")
